...
func Update(w http.ResponseWriter, r *http.Request) {
	if r.Method == "POST" {
		...
		if err != nil {
			log.Println("Erro na converção do id:", err)
		}
		...
		precoConvertidoParaFloat, err := strconv.ParseFloat(preco, 64)
		if err != nil {
			log.Println("Erro na converção do preco:", err)
		}

		models.AtualizaProduto(idConvertidaParaInt, nome, descricao, precoConvertidoParaFloat, quantidadeParaInt)
